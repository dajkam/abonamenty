...
class Admin(
       ...
       kiedy_zmodyfikowano: Date
        ...
        id, imie, nazwisko, haslo, email, role, czy_zarchiwizowany, aktywne, nie_wygasniete, nie_zablokowane, nie_wygasniete_id_i_haslo, kiedy_utworzono, kiedy_zmodyfikowano
) {
    constructor():this(
            -1,
            "",
